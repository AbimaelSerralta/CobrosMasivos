...
namespace Franquicia.Bussiness
{
    ...
    {
        public void CorreoLiga(string Nombre, string Asunto, string Concepto, decimal Importe, DateTime Vencimiento, string LigaUrl, string Correo)
        {
            ...
            string ho = "<!DOCTYPE html>\r\n" +
                ...
                "\r\n\r\n\t\t\t\t\t\t<br/><br/><a style =\"display:block;color:#fff;font-weight:400;text-align:center;width:230px;font-size:20px;text-decoration:none;background:#28a745;margin:0 auto;padding:15px 0\" href=" + LigaUrl + "> Pagar</a>" +
