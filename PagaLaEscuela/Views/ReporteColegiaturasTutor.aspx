<%@ Page Title="ReporteColegiaturasTutor" Language="C#" MasterPageFile="~/Views/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReporteColegiaturasTutor.aspx.cs" Inherits="PagaLaEscuela.Views.ReporteColegiaturasTutor" %>
                                ...
                                <div class="row">
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td style="width: 15%; padding-right: 5px;">
                                                <asp:Image ID="imgLogoSelect" Width="62" Height="40" class="img-fluid pull-right" alt="logoEscuela" runat="server" />
                                                <%--<div style="width: 100%;">
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvPagos" OnRowCreated="gvPagos_RowCreated" OnPageIndexChanging="gvPagos_PageIndexChanging" OnSorting="gvPagos_Sorting" OnRowCommand="gvPagos_RowCommand" OnRowDataBound="gvPagos_RowDataBound" AllowSorting="true" AutoGenerateColumns="false" CssClass="table table-hover" DataKeyNames="UidFechaColegiatura" GridLines="None" border="0" AllowPaging="true" PageSize="10" ShowFooter="false" runat="server">
                                            <EmptyDataTemplate>
                                                <div class="alert alert-info">No hay <strong>colegiaturas</strong> con los criterios de busqueda.</div>
                                            </EmptyDataTemplate>
                                            <Columns>
                                                ...
                                                <asp:TemplateField SortExpression="NombreCompleto" HeaderText="ALUMNO">
                                                    <ItemTemplate>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cBodyBottom" runat="server">
    ...
    <div id="ModalBusquedaColegiatura" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <div class="modal-header" style="padding-bottom: 0px; padding-top: 5px; margin-bottom: 5px;">
                            <h5 class="modal-title" runat="server">
                                <asp:Label ID="Label7" Text="Filtro de busqueda" runat="server" /></h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                    ...
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="txtColegiatura" style="color: black;">Colegiatura</label>
                                                    <asp:TextBox ID="TextBox1" Style="margin-top: 8px;" CssClass="form-control" aria-label="Search" runat="server" />
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label for="txtNumPago" style="color: black;"># de pago</label>
                                                    <asp:TextBox ID="TextBox2" Style="margin-top: 8px;" CssClass="form-control" TextMode="Number" aria-label="Search" runat="server" />
                                                    <asp:FilteredTextBoxExtender FilterType="Numbers, Custom" TargetControlID="TextBox2" runat="server" />
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="ListBox2" style="color: black; padding-left: 0px;">Estatus</label>
                                                    <asp:ListBox ID="ListBox2" runat="server" SelectionMode="Multiple"></asp:ListBox>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="ListBox3" style="color: black; padding-left: 0px;">Pago</label>
                ...
                <div class="modal-footer justify-content-center" style="padding-top: 5px; padding-bottom: 5px;">
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <asp:LinkButton ID="LinkButton6" OnClick="btnBuscar_Click" CssClass="btn btn-primary btn-round" runat="server">
                            <i class="material-icons">search</i> Buscar
                            </asp:LinkButton>
                            <asp:LinkButton ID="LinkButton7" OnClick="btnLimpiar_Click" CssClass="btn btn-warning btn-round" runat="server">
                            <i class="material-icons">clear_all</i> Limpiar
                            </asp:LinkButton>
                        </ContentTemplate>
                    </asp:UpdatePanel>
    ...
    <script>
        function showModalBusquedaColegiatura() {
            $('#ModalBusquedaColegiatura').modal('show');
            multiFiltro();
        }
        function hideModalBusquedaColegiatura() {
            $('#ModalBusquedaColegiatura').modal('hide');
        }
    </script>
    <script>
