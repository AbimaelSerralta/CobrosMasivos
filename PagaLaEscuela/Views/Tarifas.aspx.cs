...
namespace PagaLaEscuela.Views
{
    public partial class Tarifas : System.Web.UI.Page
    {
        ...
        {
            superComisionesTarjetasPragaServices.EliminarComisionesTarjeta();
            superPromocionesPragaServices.EliminarSuperPromocionesPraga();
            superPromocionesPragaServices.EliminarCodigoPromocionesPraga();
            ...
            foreach (GridViewRow row in gvTipoTarjetaPraga.Rows)
            {
                ...
                superComisionesTarjetasPragaServices.RegistrarComisionesTarjeta(cbComisionPraga.Checked, decimal.Parse(txtComisionTipoTarjetaPraga.Text), UidTipoTarjeta);
                ...
                foreach (GridViewRow rowPT in gvPromocionesPraga.Rows)
                {
                    ...
                    TextBox txtCodigoPraga = rowPT.FindControl("txtCodigoPraga") as TextBox;
                    ...
                    if (cbPromocionPraga.Checked)
                    {
                        ...
                        superPromocionesPragaServices.RegistrarSuperPromocionesPraga(UidPromocion, DcmComicion, DcmApartirDe, UidTipoTarjeta);
                    }

                    superPromocionesPragaServices.RegistrarCodigoPromocionesPraga(txtCodigoPraga.Text, UidPromocion, UidTipoTarjeta);
                }
