                                    ...
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="txtCuenta" style="color: black;">Cuenta</label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="txtRegistroDesde" style="color: black;">Fecha Pago(desde)</label>
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="txtImporteMayor" style="color: black;"></label>
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="txtImporteMenor" style="color: black;"></label>
