<%@ Page Title="UsuariosFranquicias" Language="C#" MasterPageFile="~/Views/MasterPage.Master" AutoEventWireup="true" CodeBehind="UsuariosFranquicias.aspx.cs" Inherits="PagaLaEscuela.Views.UsuariosFranquicias" %>
                                                ...
                                                <div class="nav-tabs-wrapper">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                <label for="FiltroPerfil" style="color: black;">Perfil</label>
                                                                <asp:TextBox ID="FiltroPerfil" CssClass="form-control" aria-label="Search" runat="server" />
                                                            </div>
                                                            <div class="form-group col-md-4">
