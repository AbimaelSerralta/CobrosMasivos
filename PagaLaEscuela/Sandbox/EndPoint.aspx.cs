        ...
        protected void btnGuardarPraga_Click(object sender, EventArgs e)
        {
            switch (ViewState["AccionEndPointPraga"].ToString())
            {
                ...
                case "GuardarEndPointPraga":
                    endPointPragaServices.RegistrarEndPointPraga(txtEntregarLiga.Text.Trim(), Guid.Parse("1F3A8ECB-806A-4970-958C-5360E2BB1009"), Guid.Parse(ViewState["UidCredencialLocal"].ToString()));
                    endPointPragaServices.RegistrarEndPointPraga(txtPagarLiga.Text.Trim(), Guid.Parse("2C1854EA-00BC-474E-BF3E-F8395819DE53"), Guid.Parse(ViewState["UidCredencialLocal"].ToString()));
        ...
        protected void btnGuardarClubPago_Click(object sender, EventArgs e)
        {
            switch (ViewState["AccionEndPointClubPago"].ToString())
            {
                ...
                case "GuardarEndPointClubPago":
                    endPointClubPagoServices.RegistrarEndPointClubPago(txtEntregarReferencia.Text.Trim(), Guid.Parse("5E6CCA56-B547-4F18-ABDD-C50D394923B3"), Guid.Parse(ViewState["UidCredencialLocal"].ToString()));
                    endPointClubPagoServices.RegistrarEndPointClubPago(txtConsultarReferencia.Text.Trim(), Guid.Parse("609302B6-0DEE-4680-B6BF-D547FD09ED12"), Guid.Parse(ViewState["UidCredencialLocal"].ToString()));
                    endPointClubPagoServices.RegistrarEndPointClubPago(txtPagarReferencia.Text.Trim(), Guid.Parse("65341240-E22B-49B4-88B5-792B80E13F97"), Guid.Parse(ViewState["UidCredencialLocal"].ToString()));
                    endPointClubPagoServices.RegistrarEndPointClubPago(txtCancelarReferencia.Text.Trim(), Guid.Parse("D8903F55-B478-452D-ACC9-A7F0524C687B"), Guid.Parse(ViewState["UidCredencialLocal"].ToString()));
