<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="PagaLaEscuela.Sandbox.Login" %>
                    ...
                    <div class="modal-footer">
                        <asp:UpdatePanel runat="server">
                            ...
                            Cancelar
                                ...
                                <asp:LinkButton ID="btnEnviar" class="btn btn-danger" Style="border: #28a745; background-color: #28a745;" runat="server">
                            Recuperar
                                </asp:LinkButton>
                            </ContentTemplate>
                        </asp:UpdatePanel>
