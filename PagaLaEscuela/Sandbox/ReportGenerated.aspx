                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label for="txtConsultarReferencia" style="color: black;">Desde</label>
                                                    <asp:TextBox ID="txtConsultarReferencia" TextMode="Date" CssClass="form-control" runat="server" />
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="txtConsultarReferencia" style="color: black;">Hasta</label>
                                                    <asp:TextBox ID="TextBox1" TextMode="Date" CssClass="form-control" runat="server" />
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="txtConsultarReferencia" style="color: black;">Referencia</label>
                                                    <asp:TextBox ID="TextBox2" CssClass="form-control" runat="server" />
                                                </div>

                                                <div class="col-md-3">
                                                    <asp:LinkButton ID="btnBscar" BorderWidth="1" CssClass="btn btn-warning btn-sm" runat="server">
                                                            <i class="material-icons">delete</i> Limpiar
                                                    </asp:LinkButton>
                                                    <asp:LinkButton ID="btnBuscar" BorderWidth="1" CssClass="btn btn-info btn-sm" runat="server">
                                        ...
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <asp:GridView ID="gvReporteGeneradas" AllowSorting="true" AutoGenerateColumns="false" CssClass="table table-hover" DataKeyNames="UidPagoIntegracion" GridLines="None" border="0" ShowHeaderWhenEmpty="true" AllowPaging="true" runat="server">
                                                    <EmptyDataTemplate>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField SortExpression="VchNombreComercial" DataField="VchNombreComercial" HeaderStyle-CssClass="text-center" HeaderText="REFERENCIA" />
