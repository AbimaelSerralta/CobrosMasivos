    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtUsuario.Text) || !string.IsNullOrEmpty(txtPassword.Text))
            {
                if (!string.IsNullOrEmpty(txtUsuario.Text))
                {
                    ...
                    {
                        lblValiPassword.Text = string.Empty;

                        manejoSesionServices.IniciarSesion(txtUsuario.Text.Trim(), txtPassword.Text.Trim());
        ...
        protected void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txtDatos.Text))
            {
                ...
                manejoSesionServices.RecoveryPassword(parametro, txtDatos.Text);
                ...
                if (manejoSesionServices.lsRecoveryPassword != null && manejoSesionServices.lsRecoveryPassword.Count != 0)
                {
                    ...
                    {
                        correosServices. CorreoRecoveryPassword(item.NombreCompleto, "Recuperar contraseña", item.StrCorreo, item.VchContrasenia, LigaUrl, item.StrCorreo);
                    }
