<%@ Page Title="AdministradoresFranquicias" Language="C#" MasterPageFile="~/Views/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdministradoresFranquicias.aspx.cs" Inherits="Franquicia.WebForms.Views.Administradores" %>
                                        ...
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:Panel ID="panelFranquicias" Visible="false" runat="server">
                                                    <div class="row">
                                                        <div class="table-responsive">
                                                            <asp:GridView ID="gvFranquicias" OnRowCreated="gvFranquicias_RowCreated" OnSorting="gvFranquicias_Sorting" OnSelectedIndexChanged="gvFranquicias_SelectedIndexChanged" OnRowDataBound="gvFranquicias_RowDataBound" AllowSorting="true" AutoGenerateColumns="false" CssClass="table table-hover" DataKeyNames="UidFranquiciatarios" GridLines="None" border="0" runat="server">
                                                                <EmptyDataTemplate>
