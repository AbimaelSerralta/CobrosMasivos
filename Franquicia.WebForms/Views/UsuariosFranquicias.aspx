<%@ Page Title="UsuariosFranquicias" Language="C#" MasterPageFile="~/Views/MasterPage.Master" AutoEventWireup="true" CodeBehind="UsuariosFranquicias.aspx.cs" Inherits="Franquicia.WebForms.Views.AdministradoresFranquicias" %>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="table-responsive">
                                            <asp:GridView ID="gvAdministradores" OnRowCreated="gvAdministradores_RowCreated" OnPageIndexChanging="gvAdministradores_PageIndexChanging" OnSorting="gvAdministradores_Sorting" OnRowCommand="gvAdministradores_RowCommand" OnRowDataBound="gvAdministradores_RowDataBound" AllowSorting="true" AutoGenerateColumns="false" CssClass="table table-hover" DataKeyNames="UidUsuario" GridLines="None" AllowPaging="true" PageSize="10" border="0" runat="server">
                                                <EmptyDataTemplate>
