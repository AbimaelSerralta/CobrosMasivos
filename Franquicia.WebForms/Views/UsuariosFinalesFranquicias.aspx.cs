...
{
    public partial class UsuariosFinalesFranquicias : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                usuariosCompletosServices.CargarFranquiciasUsuariosFinales(new Guid(ViewState["UidFranquiciaLocal"].ToString()), new Guid("E39FF705-8A01-4302-829A-7CFB9615CC8F"));
                ...
                perfilesServices.CargarPerfilesClienteDropDownListModel(new Guid(ViewState["UidFranquiciaLocal"].ToString()), new Guid("E39FF705-8A01-4302-829A-7CFB9615CC8F"));
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            permisosMenuModels = permisosMenuModels.Where(x => x.UidSegModulo == new Guid("9A30D515-5F88-41E1-BD21-995624EEEAF8")).ToList();
            foreach (var item in permisosMenuModels)
            {
                        ...
                        if (!validacionesServices.ExisteUsuario(ViewState["txtUsuario.Text"].ToString()))
                        {
                            if (ViewState["txtPassword.Text"].ToString().Equals(ViewState["txtRepetirPassword.Text"].ToString()))
                            {
                                if (!validacionesServices.ExisteCorreo(txtCorreo.Text))
                                {
                                    ...
                                    if (usuariosCompletosServices.RegistrarFranquiciasUsuarios(UidUsuario,
                                    ...
                                    txtNumero.Text.Trim(), Guid.Parse("B1055882-BCBA-4AB7-94FA-90E57647E607"), new Guid(ViewState["UidFranquiciaLocal"].ToString()), ddlIncluirDir.SelectedValue))
                                    {
                                        if (ddlIncluirDir.SelectedValue == "SI")
                                        {
                                            if (usuariosCompletosServices.RegistrarFranquiciasDireccionUsuarios(UidUsuario, Identificador, Pais, Estado, Municipio, Ciudad, Colonia, Calle, EntreCalle, YCalle, NumeroExterior, NumeroInterior, CodigoPostal, Referencia))
                                            {
                ...
                else if (ViewState["Accion"].ToString() == "Actualizar")
                {
                    if (item.Actualizar)
                    {
                        ...
                        if (txtPassword.Text.Equals(txtRepetirPassword.Text))
                        {
                            ...
                            if (Actualizar)
                            {
                                if (usuariosCompletosServices.ActualizarFranquiciasUsuarios(
                                Guid.Parse(ViewState["UidRequerido"].ToString()), txtNombre.Text.Trim().ToUpper(), txtApePaterno.Text.Trim().ToUpper(), txtApeMaterno.Text.Trim().ToUpper(), txtCorreo.Text.Trim().ToUpper(), new Guid(ddlEstatus.SelectedValue), txtUsuario.Text.Trim().ToUpper(), txtPassword.Text.Trim(), new Guid("18E9669B-C238-4BCC-9213-AF995644A5A4"),
                                txtNumero.Text.Trim(), Guid.Parse("B1055882-BCBA-4AB7-94FA-90E57647E607"), new Guid(ViewState["UidFranquiciaLocal"].ToString())))
                                {
                                    if (ddlIncluirDir.SelectedValue == "SI")
                                    {
                                        if (validacionesServices.ExisteDireccionUsuario(Guid.Parse(ViewState["UidRequerido"].ToString())))
                                        {
                                            if (usuariosCompletosServices.ActualizarFranquiciasDireccionUsuarios(Guid.Parse(ViewState["UidRequerido"].ToString()), Identificador, Pais, Estado, Municipio, Ciudad, Colonia, Calle, EntreCalle, YCalle, NumeroExterior, NumeroInterior, CodigoPostal, Referencia))
                                            {
                                                pnlAlert.Visible = true;
                                        ...
                                        {
                                            if (usuariosCompletosServices.RegistrarFranquiciasDireccionUsuarios(Guid.Parse(ViewState["UidRequerido"].ToString()), Identificador, Pais, Estado, Municipio, Ciudad, Colonia, Calle, EntreCalle, YCalle, NumeroExterior, NumeroInterior, CodigoPostal, Referencia))
                                            {
                                                pnlAlert.Visible = true;
                                                lblMensajeAlert.Text = "<b>¡Felicidades! </b> se ha registrado exitosamente.";
                                                divAlert.Attributes.Add("class", "alert alert-success alert-dismissible fade show");
                ...
                {
                    if (validacionesServices.ExisteUsuarioFranquicia(Guid.Parse(ViewState["UidFranquiciaLocal"].ToString()), Guid.Parse(ViewState["usuarioCompleto.UidUsuario"].ToString())))
                    {
                        lblValidar.Text = "Lo sentimos, el usuario ya esta asociado.";
                    }
                    else
                    {
                        if (usuariosCompletosServices.AsociarUsuarioFranquicia(Guid.Parse(ViewState["UidFranquiciaLocal"].ToString()), Guid.Parse(ViewState["usuarioCompleto.UidUsuario"].ToString())))
                        {
                            usuariosCompletosServices.CargarFranquiciasUsuariosFinales(new Guid(ViewState["UidFranquiciaLocal"].ToString()), new Guid("E39FF705-8A01-4302-829A-7CFB9615CC8F"));
                            gvAdministradores.DataSource = usuariosCompletosServices.lsUsuariosCompletos;
                            gvAdministradores.DataBind();
        ...
        {
            usuariosCompletosServices.BuscarUsuariosFinales(new Guid(ViewState["UidFranquiciaLocal"].ToString()), new Guid("E39FF705-8A01-4302-829A-7CFB9615CC8F"), FiltroNombre.Text, FiltroApePaterno.Text, FiltroApeMaterno.Text, FiltroCorreo.Text, Guid.Parse(FiltroEstatus.SelectedValue));
            gvAdministradores.DataSource = usuariosCompletosServices.lsUsuariosCompletos;
            gvAdministradores.DataBind();
        ...
        protected void btnBuscarUsuario_Click(object sender, EventArgs e)
        {
            ...
            usuariosCompletosServices.AsociarFranquiciaUsuariosFinales(FiltroCorreoUsuario.Text);
            ...
            txtReferencia.Text = direccionesUsuariosServices.direccionesUsuariosRepository.direccionesUsuarios.Referencia;
            //==================TELÉFONO===================================
            telefonosUsuariosServices.ObtenerTelefonoUsuarioSinPrefijo(usuariosCompletosServices.usuariosCompletosRepository.usuarioCompleto.UidUsuario);
            txtNumero.Text = telefonosUsuariosServices.telefonosUsuariosRepository.telefonosUsuarios.VchTelefono;
            ddlTipoTelefono.SelectedIndex = ddlTipoTelefono.Items.IndexOf(ddlTipoTelefono.Items.FindByValue(telefonosUsuariosServices.telefonosUsuariosRepository.telefonosUsuarios.UidTipoTelefono.ToString()));
