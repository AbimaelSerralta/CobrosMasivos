...
{
    public partial class GenerarLigasFranquicias : System.Web.UI.Page
    {
        #region Propiedades
        // Nombre del servidor
        string ServerName
        ...
        {
            usuariosCompletosServices.CargarUsuariosFinalesFranquicias(usuariosCompletosServices.lsgvUsuariosSeleccionados, new Guid(ViewState["UidFranquiciaLocal"].ToString()), new Guid("E39FF705-8A01-4302-829A-7CFB9615CC8F"));
        ...
        protected void cbSeleccionar_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                usuariosCompletosServices.ActualizarListaUsuariosFranquicias(usuariosCompletosServices.lsLigasUsuariosGridViewModel, dataKey, true);
            }
            else
            {
                usuariosCompletosServices.ActualizarListaUsuariosFranquicias(usuariosCompletosServices.lsLigasUsuariosGridViewModel, dataKey, false);
            }
        ...
        {
            usuariosCompletosServices.gvUsuariosSeleccionadosFranquicias(usuariosCompletosServices.lsLigasUsuariosGridViewModel);
            gvUsuariosSeleccionados.DataSource = usuariosCompletosServices.lsgvUsuariosSeleccionados;
            gvUsuariosSeleccionados.DataBind();
