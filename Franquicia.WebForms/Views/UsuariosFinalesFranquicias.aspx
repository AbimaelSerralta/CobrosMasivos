<%@ Page Title="UsuariosFinalesFranquicias" Language="C#" MasterPageFile="~/Views/MasterPage.Master" AutoEventWireup="true" CodeBehind="UsuariosFinalesFranquicias.aspx.cs" Inherits="Franquicia.WebForms.Views.UsuariosFinalesFranquicias" %>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active show" id="general">
                                        <asp:UpdatePanel ID="upAsosiarUsuario" runat="server">
                                            <ContentTemplate>
