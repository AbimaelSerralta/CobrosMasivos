                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="table-responsive">
                                            <asp:GridView ID="gvAdministradores" OnPageIndexChanging="gvAdministradores_PageIndexChanging" OnRowCreated="gvAdministradores_RowCreated" OnSorting="gvAdministradores_Sorting" OnRowCommand="gvAdministradores_RowCommand" OnRowDataBound="gvAdministradores_RowDataBound" AllowSorting="true" AutoGenerateColumns="false" CssClass="table table-hover" DataKeyNames="UidUsuario" GridLines="None" AllowPaging="true" PageSize="10" border="0" runat="server">
                                                <EmptyDataTemplate>
                                        ...
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:Panel ID="panelFranquicias" Visible="false" runat="server">
                                                    <div class="row">
                                                        <div class="table-responsive">
                                                            <asp:GridView ID="gvClientes" OnRowCreated="gvClientes_RowCreated" OnSorting="gvClientes_Sorting" OnSelectedIndexChanged="gvClientes_SelectedIndexChanged" OnRowDataBound="gvClientes_RowDataBound" AllowSorting="true" AutoGenerateColumns="false" CssClass="table table-hover" DataKeyNames="UidCliente" GridLines="None" AllowPaging="true" border="0" runat="server">
                                                                <EmptyDataTemplate>
