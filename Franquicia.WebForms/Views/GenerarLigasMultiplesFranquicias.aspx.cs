...
{
    public partial class GenerarLigasMultiplesFranquicias : System.Web.UI.Page
    {
        #region Propiedades
        // Nombre del servidor
        string ServerName
            ...
            if (fuSelecionarExcel.HasFile)
            {
...

                {
                        ...
                        && dt.Columns.Contains("IMPORTE".Trim()) && dt.Columns.Contains("VENCIMIENTO".Trim()) && dt.Columns.Contains("PROMOCION(ES)".Trim()))
                    {
                        ...
                        usuariosCompletosServices.ValidarExcelToListMultipleFranquicias(dt, promocionesServices.lsFranquiciasCBLPromocionesModel);

                        if (usuariosCompletosServices.lsLigasInsertarMultiple.Count >= 1)
                        {
                            usuariosCompletosServices.ExcelToListMultipleFranquicas(usuariosCompletosServices.lsgvUsuariosSeleccionadosMultiple, usuariosCompletosServices.lsLigasInsertarMultiple, Guid.Parse(ViewState["UidFranquiciaLocal"].ToString()));
                            ...
                            foreach (var item in usuariosCompletosServices.lsgvUsuariosSeleccionadosMultiple)
                            {
                                ...
                                foreach (var it in promocionesServices.lsFranquiciasCBLPromocionesModel)
                                {
        ...
        {
            usuariosCompletosServices.CargarUsuariosFinalesMultiplesFranquicias(usuariosCompletosServices.lsgvUsuariosSeleccionadosMultiple, new Guid(ViewState["UidFranquiciaLocal"].ToString()), new Guid("E39FF705-8A01-4302-829A-7CFB9615CC8F"));
        ...
        protected void cbSeleccionar_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                usuariosCompletosServices.ActualizarListaUsuariosMultipleFranquicias(usuariosCompletosServices.lsLigasMultiplesUsuariosGridViewModel, dataKey, true);
            }
            else
            {
                usuariosCompletosServices.ActualizarListaUsuariosMultipleFranquicias(usuariosCompletosServices.lsLigasMultiplesUsuariosGridViewModel, dataKey, false);
            }
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            usuariosCompletosServices.gvUsuariosSeleccionadosMultipleFranquicia(usuariosCompletosServices.lsLigasMultiplesUsuariosGridViewModel);
            gvUsuariosSeleccionados.DataSource = usuariosCompletosServices.lsgvUsuariosSeleccionadosMultiple;
            gvUsuariosSeleccionados.DataBind();
        ...
        protected void gvUsuariosSeleccionados_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "btnAceptar")
            {
                ...
                usuariosCompletosServices.ActualizarListaGvUsuariosMultipleFranquicias(usuariosCompletosServices.lsgvUsuariosSeleccionadosMultiple, dataKey, true, txtGvAsunto.Text, txtGvConcepto.Text, decimal.Parse(txtGvImporte.Text), DateTime.Parse(txtGvVencimiento.Text), Promociones);
                gvUsuariosSeleccionados.DataSource = usuariosCompletosServices.lsgvUsuariosSeleccionadosMultiple;
                gvUsuariosSeleccionados.DataBind();
            }
            ...
            if (e.CommandName == "btnEliminar")
            {
                ...
                usuariosCompletosServices.EliminarItemgvUsuariosSeleccionadosMultipleFranquicias(dataKey);
        ...
        protected void gvUsuariosSeleccionados_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    GvListBoxMultiple.DataSource = promocionesServices.lsFranquiciasCBLPromocionesModel;
                    ...
                    if (VariasLigas)
                    {
                        ...
                        if (urlCobro.Contains("https://"))
                        {
                            if (usuariosCompletosServices.GenerarLigasPagos(urlCobro, item.StrConcepto, item.DcmImporte, ReferenciaCobro, item.UidUsuario, txtIdentificador.Text, thisDay, item.DtVencimiento, item.StrAsunto, UidLigaAsociado, Guid.Empty, Guid.Parse(ViewState["UidFranquiciaLocal"].ToString()), 0, 0, 0))
                            {
                                ...
                                {
                                    int i = promocionesServices.lsFranquiciasCBLPromocionesModel.IndexOf(promocionesServices.lsFranquiciasCBLPromocionesModel.First(x => x.UidPromocion == itPromo.UidPromocion));
        ...
        {
            usuariosCompletosServices.BuscarUsuarios(usuariosCompletosServices.lsLigasMultiplesUsuariosGridViewModel, new Guid(ViewState["UidFranquiciaLocal"].ToString()), new Guid("E39FF705-8A01-4302-829A-7CFB9615CC8F"), FiltroNombre.Text, FiltroApePaterno.Text, FiltroApeMaterno.Text, FiltroCorreo.Text, FiltroTelefono.Text);
            gvUsuarios.DataSource = usuariosCompletosServices.lsLigasMultiplesUsuariosGridViewModel.Where(x => x.blSeleccionado == false).ToList();
            gvUsuarios.DataBind();
        }
